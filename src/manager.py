...
class Manager(object):
    ...
    def __init__(self) -> None:
        ...
        self.wppSocketClient = services.WPPSocketIOClient(self)
        self.webServer = services.WebServer(self)
    ...
    async def __start_session(self) -> None:
        ...
        async def __get_session_token(self):
            ...
            response = await self.wpp_api_client.makeRequest("POST", endpoint)
    ...
    async def __wait_qr_scan(self):
        ...
        while self.session.status == "WAITING":
            response = await __get_session_status(self)
